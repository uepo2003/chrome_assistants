...
(function () {
  ...
  var TRANSLATIONS = {
    en: {
      ...
      'popup.warningBody': 'Choose Gemini, Claude, DeepSeek, or OpenAI in settings and add an API key to use AI-powered steps.',
      'popup.warningButton': 'Set API key',
      ...
      'options.sec.appearance': 'Appearance',
      'options.appearance.desc': 'Match your system, or lock the UI to light or dark. Applies to popup, side panel, and this page.',

      // ----- theme toggle (popup / sidepanel / options) -----
      'theme.groupAria': 'Theme',
      'theme.system.label': 'System',
      'theme.system.short': 'Auto',
      'theme.system.aria': 'Match system theme',
      'theme.light.label': 'Light',
      'theme.light.short': 'Light',
      'theme.light.aria': 'Use light theme',
      'theme.dark.label': 'Dark',
      'theme.dark.short': 'Dark',
      'theme.dark.aria': 'Use dark theme',
      'theme.cycleAria': 'Cycle theme (system, light, dark)',
      'theme.cycleTitle': 'Theme',

      // ----- options provider/keys (Team E) -----
      'options.sec.provider': 'AI Provider',
      'options.provider.desc': "Choose the LLM provider first. Add that provider's API key and pick its model below.",
      ...
      'options.provider.fallbackLabel': 'Fallback provider (optional)',
      ...
      'options.provider.modelHint': 'Model used with the selected provider.',
      'options.sec.apiKeys': 'API Keys',
      'options.apiKeys.desc': 'Paste the API key for the selected provider. Any saved provider key clears the popup warning.',
      'options.apiKeys.selectedTag': 'Selected',
      ...
      'error.recipeMissingApiKey': 'Add an API key for Gemini, Claude, DeepSeek, or OpenAI in settings to run this recipe.',
    ...
    ja: {
      ...
      'popup.warningBody': '設定画面で Gemini / Claude / DeepSeek / OpenAI のいずれかを選び、API キーを登録してください。',
      'popup.warningButton': 'API キーを設定',
      ...
      'options.sec.appearance': '外観',
      'options.appearance.desc': 'OSと連動させるか、ライト／ダークに固定できます。ポップアップ・サイドパネル・このページすべてに反映されます。',

      // ----- theme toggle (popup / sidepanel / options) -----
      'theme.groupAria': 'テーマ',
      'theme.system.label': 'システム',
      'theme.system.short': '自動',
      'theme.system.aria': 'OS のテーマに合わせる',
      'theme.light.label': 'ライト',
      'theme.light.short': 'ライト',
      'theme.light.aria': 'ライトテーマにする',
      'theme.dark.label': 'ダーク',
      'theme.dark.short': 'ダーク',
      'theme.dark.aria': 'ダークテーマにする',
      'theme.cycleAria': 'テーマを切り替える（システム→ライト→ダーク）',
      'theme.cycleTitle': 'テーマ',

      // ----- options provider/keys (Team E) -----
      'options.sec.provider': 'AI プロバイダー',
      'options.provider.desc': '先に使う LLM プロバイダーを選びます。そのプロバイダーの API キーとモデルを下で設定します。',
      ...
      'options.provider.fallbackLabel': 'フォールバック先（任意）',
      'options.provider.fb.anthropic': 'Anthropic Claude',
      'options.provider.fb.gemini': 'Gemini（Google）',
      'options.provider.fb.deepseek': 'DeepSeek',
      'options.provider.fb.openai': 'OpenAI',
      ...
      'options.apiKeys.desc': '選択中のプロバイダーの API キーを貼り付けてください。どれか 1 つでも保存済みならポップアップの警告は消えます。',
      'options.apiKeys.selectedTag': '選択中',
      ...
      'error.recipeMissingApiKey': '設定で Gemini / Claude / DeepSeek / OpenAI のいずれかの API キーを登録してから実行してください。',
